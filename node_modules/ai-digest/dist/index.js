...
async function readIgnoreFile(inputDir, filename = '.aidigestignore') {
    try {
...
async function aggregateFiles(inputDir, outputFile, useDefaultIgnores, removeWhitespaceFlag, showOutputFiles) {
    try {
        ...
        const customIgnore = (0, utils_1.createIgnoreFilter)(userIgnorePatterns);
